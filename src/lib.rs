// src/lib.rs
/*
 * Core library for EchidnaGanache
 */
...
#[derive(Debug)]
pub struct EchidnaGanacheProcessor {
    verbose: bool,
    processed_count: usize,
}

impl EchidnaGanacheProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting EchidnaGanache processing");
    
    let mut processor = EchidnaGanacheProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = EchidnaGanacheProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = EchidnaGanacheProcessor::new(false);
